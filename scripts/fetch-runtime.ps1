...
# 用法：powershell -File scripts/fetch-runtime.ps1 [-NodeVersion 24.19.0] [-DshVersion 0.1.0-rc.6]
[CmdletBinding()]
param(
...
Set-Content (Join-Path $dest 'RUNTIME_VERSIONS.txt') "node $NodeVersion`r`ndsh $DshVersion"
